...
export const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl leading-[1.1] sm:text-6xl md:text-8xl lg:text-[7rem] font-black tracking-tighter sm:leading-[1.05] mb-8 text-black drop-shadow-sm break-words overflow-hidden max-w-full">
